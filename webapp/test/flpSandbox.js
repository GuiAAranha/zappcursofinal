		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zappcursofinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zappcursofinal-display": {
								"semanticObject": "zappcursofinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zappcursofinal",
									"url": sap.ui.require.toUrl("zappcursofinal")
								}
							}
						}
					}
